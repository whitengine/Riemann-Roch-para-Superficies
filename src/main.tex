...
\begin{obs}
A priori podría suceder que la dimensión de $\O_x/(f,g)$ como $k$-espacio vectorial sea infinita, sin embargo, como $C$ y $C'$ son curvas distintas, resulta que $\dim_k \O_x /(f,g)$ es finito, ya que podemos aplicar el siguiente resultado (cf. \cite[Corolario 11.8]{atiyah2018introductionToCommutativeAlgebra})
\begin{quote}
